...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]      tmp = realloc((void *)*up, asize);
 [EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]      tmp___1 = tmp;
...
[EXEC]}
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]static void prpending(char *lim ) 
  { 
  char *nl ;
  void *tmp ;
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]      prpending(beg);
...
[EXEC]    lastnl = bufbeg;
                  {
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]      lastout = bufbeg;
      }
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]        prpending(lim);
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]      clrbit('\000', ccl);
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]  {
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]               {
            _L___0: 
                           {
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]            tmp___5 = 2;
            }       
                        
           
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]          if (constraint & (1 << ((tmp___5 + 1) + 4))) {
                          {
                                             ...
                                             {
[EXEC]              (d->states + i)->constraint = (unsigned char )((int )(d->states + i)->constraint | constraint);
             }       
...
[EXEC]    if (! (i < merged.nelem)) {
 [EXEC]      goto while_break___8;
                                                                                                ...
                                                                                                {
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]      wants_newline = 1;
      }
[EXEC]    i ++;
   }
  while_break___8: /* CIL Label */ ;
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]          goto while_break___15;
          }
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI][EXEC]        if (((follows.elems + j)->constraint & 192U) >> 2 != ((follows.elems + j)->constraint & 48U)) {
            wants_newline = 1;
        }
[EXEC]        j ++;
       }
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]            *(trans___0 + c) = state_newline;
  [EXEC]          } else {
             {
...
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]    tmp = 2;
  [EXEC]  } else {
 [EXEC]    tmp = 0;
   }
...
[EXEC]    if ((int )(d->states + s)->constraint & (1 << tmp___0)) {
 ...
 [EXEC]  }
 [EXEC]  if ((d->states + s)->newline) {
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]    tmp___1 = 2;
  [EXEC]  } else {
 [EXEC]    tmp___1 = 0;
   }
...
[EXEC]    if ((int )(d->states + s)->constraint & (1 << (tmp___2 + 1))) {
 ...
 [EXEC]  }
 [EXEC]  if ((d->states + s)->newline) {
[EXEC_IN_DEBLOAT_BUT_NOT_EXEC_IN_ORI] [EXEC]    tmp___3 = 2;
  [EXEC]  } else {
 [EXEC]    tmp___3 = 0;
   }
